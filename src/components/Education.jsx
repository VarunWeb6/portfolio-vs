        ...
        >
          {educationData.map((edu, index) => (
            <motion.div
              ...
              className={`relative border rounded-xl p-8 transition-all duration-300 bg-gray-900/50 backdrop-blur-sm transform ${
                hoveredIndex === index
                  ? "border-teal-500 scale-200"
                  : "border-blue-400/20 scale-100"
              }`}
